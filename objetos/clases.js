...
class Perro {
  ...
  truco(){
    return this.nombre + ' dio la vuelta' + ` o ${this.nombre} dio vuelta`
  }
  ...
  // modifica o establece un atributo
  setColor(color){
...
// Instancia/Objeto
const snoopy = new Perro('Snoopy','Blanco con negro');
const ayudanteDeSanta = new Perro('Ayudante de Santa','Cafe');
const scrappy = new Perro('Scrappy','Cafe');
console.log(snoopy.nombre);
console.log(ayudanteDeSanta.comer('numeros'));
console.log(scrappy.truco());
...
//     Crea una Clase llamado myPenguin con propiedades que representen
